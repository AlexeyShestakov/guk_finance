...
foreach ($item_ids as $root_menu_id) {
    ...
    \Sportbox\Helpers::assert($menu_obj);

    $menu_edit_url = \Sportbox\CRUD\ControllerCRUD::getEditUrlForObj($menu_obj);
    ...
    <li id="menu-tree-<?= $menu_obj->getId() ?>"
        ...
        <ul style=" list-style-type: none;">
            ...
            if (!empty($children_ids_arr)) {
                echo \Sportbox\Tree\Controller::renderSubtreeForClassName($model_class_name, $menu_obj->getId(), $level);
            }
