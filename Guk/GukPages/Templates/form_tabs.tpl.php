...
<ul class="nav nav-tabs">
    <li role="presentation" <?php if ($camn == 'finFormPageAction') echo ' class="active" ';?> ><a href="<?php echo \Guk\GukPages\ControllerForms::finFormPageAction(1, $form_obj->getId()); ?>">Поля</a></li>
