...
<form class="form-horizontal" method="post" action="<?php echo \Guk\VuzPage\ControllerVuz::paymentUrl($payment_obj->getId()); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input class="form-control" id="exampleInputEmail1" name="title" value="<?php echo $payment_obj->getTitle(); ?>" readonly>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input class="form-control" id="exampleInputEmail1" name="amount_rub" value="<?php echo $payment_obj->getAmountRub(); ?>" readonly>
        </div>
    ...
    if ($payment_obj->getStatusCode() == \Guk\VuzPayment::STATUS_SENT_TO_VUZ) {
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="button" class="form-control btn btn-success" data-toggle="modal" data-target="#paymentReceived">Платеж получен</button>
            </div>
        </div>
        ...
        <div class="modal-content">
            <form method="post" action="<?= \Guk\VuzPage\ControllerVuz::paymentUrl($payment_obj->getId()) ?>">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Подтверждение получения платежа</h4>
                </div>
