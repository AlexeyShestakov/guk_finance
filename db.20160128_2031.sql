...
INSERT INTO `detail_columns` VALUES (1,'Наименование расходов (услуги, закупки, работы)',2,0),(2,'Ед. изм.',2,0),(3,'Потребность',2,0),(4,'Примерная стоимость за единицу (тыс. руб.)',2,0),(5,'Общая стоимость (тыс. руб.)',2,0),(6,'Ожидаемый результат и краткое обоснование',2,0);
...
-- Dump completed on 2016-01-28 20:31:12
