...
<h1><a href="<?php echo \Guk\GukPages\ControllerFinFormsPage::getFinFormsPageUrl(); ?>">Формы</a> / <a href="<?php echo \Guk\GukPages\ControllerFinFormsPage::getFinFormPageUrl($form_id); ?>"><?php echo \Cebera\Helpers::replaceEmptyValue($form_obj->getComment()); ?></a> / Колонка</h1>

<div>&nbsp;</div>

<form class="form-horizontal" method="post" action="<?php echo \Guk\GukPages\ControllerFinFormsPage::getFinFormColUrl($col_obj->getId()); ?>">
