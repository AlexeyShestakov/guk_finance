...
class PaymentTemplate
{
    static public function render($payment_id){
        ...
        <h1><a href="<?php echo \Guk\Pages\Payments\Controller::paymentsUrl(); ?>">Платежи</a> / <?php echo \Guk\Helpers::replaceEmptyString($payment_obj->getTitle()); ?></h1>

        <div>&nbsp;</div>

        <form class="form-horizontal" method="post" action="<?php echo \Guk\Pages\Payments\Controller::paymentUrl($payment_obj->getId()); ?>">
        ...
        <div class="modal fade" id="sendToVuzModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form method="post" action="<?= \Guk\Pages\Payments\Controller::paymentUrl($payment_obj->getId()) ?>">
