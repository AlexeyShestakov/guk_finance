...
class ImagePresets
{
    ...
    const IMAGE_PRESET_270_152_outbound = "270_152_outbound"; // похожие материалы под нодой

    const IMAGE_PRESET_450_253 = "450_253";
    const IMAGE_PRESET_450x253 = "450x253"; // API1 preset
    ...
    const IMAGE_PRESET_690_388 = '690_388'; // лого материала, на странице ноды

    const IMAGE_PRESET_320_240 = '320_240';
    const IMAGE_PRESET_240_135 = '240_135';

    const IMAGE_PRESET_SMARTTV_330_186 = 'smarttv-330x186'; // API1 preset
    const IMAGE_PRESET_SMARTTV_330_205 = 'smarttv-330x205'; // API1 preset
    ...
    const IMAGE_PRESET_120_80 = "120_80";
    const IMAGE_PRESET_360_240 = "360_240";
    const IMAGE_PRESET_540_360 = "540_360";
    const IMAGE_PRESET_640_426 = "640_426";
    const IMAGE_PRESET_640_640 = "640_640";
    const IMAGE_PRESET_720_480 = "720_480";
    const IMAGE_PRESET_750_500 = "750_500";
    const IMAGE_PRESET_1080_720 = "1080_720";
    const IMAGE_PRESET_1242_828 = "1242_828";
    const IMAGE_PRESET_1242_auto = "1242_auto";
    const IMAGE_PRESET_1024_auto = "1024_auto";
    const IMAGE_PRESET_1440_auto = "1440_auto";
    const IMAGE_PRESET_2160_auto = "2160_auto";
    ...
    public static function processImageByPreset(\Imagine\Image\ImageInterface $imageObject, $presetName)
    {
        ...
        switch ($presetName) {
            ...
            case self::IMAGE_PRESET_480_270:
                return $imageObject->thumbnail(new \Imagine\Image\Box(480, 270), \Imagine\Image\ImageInterface::THUMBNAIL_INSET);
                break;
            ...
            case self::IMAGE_PRESET_120_80:
                $preset_width = 120;
                $preset_height = 80;

                $original_image_size_obj = $imageObject->getSize();
                if($original_image_size_obj->getWidth() < $preset_width) {
                    $original_image_aspect_ratio = $original_image_size_obj->getWidth() / $original_image_size_obj->getHeight();

                    $scaled_box_size = new \Imagine\Image\Box($preset_width, intval($preset_width / $original_image_aspect_ratio));
                    $imageObject->resize($scaled_box_size);
                }

                $resised_image_obj = $imageObject->thumbnail(new \Imagine\Image\Box($preset_width, $preset_height), \Imagine\Image\ImageInterface::THUMBNAIL_OUTBOUND);
                $blackouted_image_obj = self::blackout($resised_image_obj);
                $watermarked_image_obj = self::appendWatermark($blackouted_image_obj);

                return $watermarked_image_obj;
                break;
            case self::IMAGE_PRESET_360_240:
                $preset_width = 360;
                $preset_height = 240;
                ...
                return $watermarked_image_obj;
                break;
            case self::IMAGE_PRESET_540_360:
                $preset_width = 540;
                $preset_height = 360;
                ...
                return $watermarked_image_obj;
                break;
            case self::IMAGE_PRESET_640_426:
                $preset_width = 640;
                $preset_height = 426;
                ...
                return $watermarked_image_obj;
                break;
            case self::IMAGE_PRESET_640_640:
                $preset_width = 640;
                $preset_height = 640;
                ...
                return $watermarked_image_obj;
                break;
            case self::IMAGE_PRESET_720_480:
                $preset_width = 720;
                $preset_height = 480;
                ...
                return $watermarked_image_obj;
                break;
            case self::IMAGE_PRESET_750_500:
                $preset_width = 750;
                $preset_height = 500;
                ...
                return $watermarked_image_obj;
                break;
            case self::IMAGE_PRESET_1080_720:
                $preset_width = 1080;
                $preset_height = 720;
                ...
                return $watermarked_image_obj;
                break;
            case self::IMAGE_PRESET_1242_828:
                $preset_width = 1242;
                $preset_height = 828;
                ...
                return $watermarked_image_obj;
                break;
            case self::IMAGE_PRESET_1242_auto:
                $preset_width = 1242;
                $original_image_size_obj = $imageObject->getSize();
                $original_image_aspect_ratio = $original_image_size_obj->getWidth() / $original_image_size_obj->getHeight();
                $new_image_height = intval($preset_width / $original_image_aspect_ratio);

                $resised_image_obj = $imageObject->thumbnail(new \Imagine\Image\Box($preset_width, $new_image_height), \Imagine\Image\ImageInterface::THUMBNAIL_OUTBOUND);
                $watermarked_image_obj = self::appendWatermark($resised_image_obj);

                return $watermarked_image_obj;
                break;

            case self::IMAGE_PRESET_1024_auto:
                $preset_width = 1024;
                $original_image_size_obj = $imageObject->getSize();
                $original_image_aspect_ratio = $original_image_size_obj->getWidth() / $original_image_size_obj->getHeight();
                $new_image_height = intval($preset_width / $original_image_aspect_ratio);
            ...
            case self::IMAGE_PRESET_1440_auto:
                $preset_width = 1440;
                $original_image_size_obj = $imageObject->getSize();
                $original_image_aspect_ratio = $original_image_size_obj->getWidth() / $original_image_size_obj->getHeight();
                $new_image_height = intval($preset_width / $original_image_aspect_ratio);
            ...
            case self::IMAGE_PRESET_2160_auto:
                $preset_width = 2160;
                $original_image_size_obj = $imageObject->getSize();
                $original_image_aspect_ratio = $original_image_size_obj->getWidth() / $original_image_size_obj->getHeight();
                $new_image_height = intval($preset_width / $original_image_aspect_ratio);
    ...
    /**
     * @param \Imagine\Image\ImageInterface|\Imagine\Image\ManipulatorInterface $image_obj
     * @return \Imagine\Image\ManipulatorInterface
     */
    protected static function appendWatermark($image_obj)
    {
        $original_image_size_obj = $image_obj->getSize();
        $original_image_aspect_ratio = $original_image_size_obj->getWidth() / $original_image_size_obj->getHeight();

        $watermark_image_path = \Cebera\KeyValue\Helper::getValueByFullName("watermark_image_path");
        \Cebera\Helpers::assert($watermark_image_path);

        $watermark_original_obj = new \Imagine\Gd\Imagine();
        $watermark_original_obj = $watermark_original_obj->open($watermark_image_path);
        /**
         * @var $watermark_original_obj \Imagine\Image\ImageInterface
         */
        $watermark_original_size_obj = $watermark_original_obj->getSize();

        if($original_image_aspect_ratio >=1) {
            $watermark_scaled_width = $watermark_original_size_obj->getWidth();
            $watermark_scaled_height = intval($watermark_scaled_width / $original_image_aspect_ratio);

            $start_point = new \Imagine\Image\Point(0, $watermark_original_size_obj->getHeight() - $watermark_scaled_height);
        } else {
            $watermark_scaled_height = $watermark_original_size_obj->getHeight();
            $watermark_scaled_width = intval($watermark_scaled_height * $original_image_aspect_ratio);

            $start_point = new \Imagine\Image\Point($watermark_original_size_obj->getWidth() - $watermark_scaled_width, 0);
        }

        $watermark_scaled_box_size = new \Imagine\Image\Box($watermark_scaled_width, $watermark_scaled_height);
        $watermark_scaled_obj = $watermark_original_obj->crop($start_point, $watermark_scaled_box_size);
        $watermark_scaled_obj->resize(
            new \Imagine\Image\Box($original_image_size_obj->getWidth(),
                $original_image_size_obj->getHeight())
        );

        return $image_obj->paste($watermark_scaled_obj, new \Imagine\Image\Point(0,0));
    }
     ...
     * @return \Imagine\Image\ManipulatorInterface
     */
    protected static function blackout($image_obj)
    {
        $blackout_image_path = \Cebera\KeyValue\Helper::getValueByFullName("blackout_image_path");
        \Cebera\Helpers::assert($blackout_image_path);

        $original_image_size_obj = $image_obj->getSize();

        $blackout_obj = new \Imagine\Gd\Imagine();
        $blackout_obj = $blackout_obj->open($blackout_image_path);
        $blackout_obj->resize(
            new \Imagine\Image\Box($original_image_size_obj->getWidth(),
                $original_image_size_obj->getHeight())
        );

        return $image_obj->paste($blackout_obj, new \Imagine\Image\Point(0,0));
