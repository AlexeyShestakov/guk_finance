...
INSERT INTO `fin_form` VALUES (1,0,0,'Расчет потребностей 2015',0),(2,1451366501,0,'Расчет потребностей 2016',1),(3,0,0,'новая форма ',0),(4,1451384600,0,'проверка создания формы',0),(5,1451408583,0,'Расчет потребностей 2017',0);
...
INSERT INTO `vuz_payment` VALUES (6,1453182199,0,'Оплата для академии РВСН по заявке 56',8000009,6,1,3);
...
-- Dump completed on 2016-01-19  9:02:16
