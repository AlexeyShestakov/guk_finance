...
<form style="background-color: #eee; padding: 20px;" class="form-horizontal" method="post" action="<?php echo \Guk\FinFormsPage\ControllerFinFormsPage::getFinFormAddPageUrl(); ?>">
