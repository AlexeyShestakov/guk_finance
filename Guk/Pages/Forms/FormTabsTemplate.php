...
<ul class="nav nav-tabs">
    <li role="presentation" <?php if ($camn == 'finFormPageAction') echo ' class="active" ';?> ><a href="<?php echo FormsController::formAction(1, $form_obj->getId()); ?>">Поля</a></li>
    ...
    <li role="presentation" <?php if ($camn == 'docsAction') echo ' class="active" ';?> ><a href="<?php echo FormsController::docsAction(1, $form_obj->getId()); ?>">Обоснование</a></li>
