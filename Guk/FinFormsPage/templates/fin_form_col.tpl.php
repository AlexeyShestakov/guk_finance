...
<h1><a href="<?php echo \Guk\FinFormsPage\ControllerFinFormsPage::getFinFormsPageUrl(); ?>">Формы</a> / <a href="<?php echo \Guk\FinFormsPage\ControllerFinFormsPage::getFinFormPageUrl($form_id); ?>"><?php echo \Cebera\Helpers::replaceEmptyValue($form_obj->getComment()); ?></a> / Колонка</h1>

<div>&nbsp;</div>

<form class="form-horizontal" method="post" action="<?php echo \Guk\FinFormsPage\ControllerFinFormsPage::getFinFormColUrl($col_obj->getId()); ?>">
