...
trait FactoryTrait {
    ...
    static public function getMyGlobalizedClassName()
    {
        ...
        $class_name = \Cebera\Model\Helper::globalizeClassName($class_name);
        return $class_name;
    }
    ...
    static public function factory($id_to_load, $exception_if_not_loaded = true)
    {
        ...
        return \Cebera\Model\FactoryHelper::factory($class_name, $id_to_load, $exception_if_not_loaded);
    }

    static public function removeObjFromCacheById($id_to_remove)
    {
        $class_name = self::getMyGlobalizedClassName();
        \Cebera\Model\FactoryHelper::removeObjFromCacheById($class_name, $id_to_remove);
    }
    ...
    {
        $class_name = self::getMyGlobalizedClassName();
        \Cebera\Model\FactoryHelper::afterUpdate($class_name, $id);
    }
    ...
    {
        $class_name = self::getMyGlobalizedClassName();
        \Cebera\Model\FactoryHelper::afterDelete($class_name, $this->id);
    }
}