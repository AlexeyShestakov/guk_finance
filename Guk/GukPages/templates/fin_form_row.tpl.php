...
<h1><a href="<?php echo \Guk\GukPages\ControllerForms::getFinFormsPageUrl(); ?>">Формы</a> / <a href="<?php echo \Guk\GukPages\ControllerForms::formUrl($form_id); ?>"><?php echo \Cebera\Helpers::replaceEmptyValue($form_obj->getComment()); ?></a> / Строка</h1>

<div>&nbsp;</div>

<form class="form-horizontal" method="post" action="<?php echo \Guk\GukPages\ControllerForms::getFinFormRowUrl($row_obj->getId()); ?>">
